...
from .layout import apply_mode_drop, apply_section_drop, build_layout, drop_mode_key, drop_section_key
...
def _set_invisible_style(gizmo, tooltip=''):
    ...
    try:
        ...
        gizmo.name = tooltip or 'Witch Quickbar'
    except Exception:
        pass
...
class WQBAR_OT_drag_dock(Operator):
    ...
    bl_description = 'Move the floating Witch Quickbar.'
    bl_options = {'REGISTER'}
...
class WQBAR_OT_resize_handle(Operator):
    ...
    bl_description = 'Resize the floating Witch Quickbar.'
    bl_options = {'REGISTER'}
...
class WQBAR_OT_drag_section(Operator):
    ...
    bl_description = 'Drag to reorder a More Tools section.'
    bl_options = {'REGISTER'}
