...
IS_DEV_BUILD = True
VERSION_LABEL = 'Dev_v2.10.1' if IS_DEV_BUILD else 'v2.10.1'
...
PANEL_ORDERS = {
    'MODE_SWITCHER': 0, 'AUTO_MIRROR': 1, 'EDIT_TOOLS': 2, 'MODIFIER_TOOL': 3,
    'HEAD_TOOLS': 4, 'BODY_TOOLS': 5, 'ARMOUR_TOOLS': 6, 'HAIR_TOOLS': 7,
    'WEIGHT_TOOLS': 8, 'ARMATURE_TOOLS': 9, 'SHAPE_KEY_TOOLS': 10, 'EXPORT_TOOLS': 11,
    'TROUBLESHOOTING_TOOLS': 12, 'FOOTER': 99,
}
